...
$member_name=$_REQUEST['student_name'];

$query ="select * from na_member where std=1"; 
$query1 ="select * from na_member where std=1"; 
                        ...
                        <div class="pm-body clearfix"  style="padding:0;">
							...
							?>
                                    ...
                                    <div class="pmbb-view" style="display: -webkit-inline-box;">
										...
										<div class="m-t-30">
										  <a class="btn btn-primary" href="student-dashboard-report.php?member=<?=  base64_encode($fetch_member['id'])?>"><i class="zmdi zmdi-account m-r-5"></i>View Profile</a>
										  <a class="btn btn-success" href="student-dashboard-report.php?member=<?=  base64_encode($fetch_member['id'])?>"><i class="zmdi zmdi-book m-r-5"></i>Programs</a>
										  <a class="btn btn-danger" href="student-dashboard-report.php?member=<?=  base64_encode($fetch_member['id'])?>"><i class="zmdi zmdi-video m-r-5"></i>Seminar</a>
