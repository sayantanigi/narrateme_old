  ...
  <section id="content"> 
    <div class="container">
      <div class="block-header">
		...
		<small><?php if($view['ind'] ==1){ echo "Individual";}?></small>
		</h2>
      </div>
              ...
              <div class="pmbb-header"> 
						  ...
						  ?>
                            ...
                            <div class="pmbb-view">
                             ...
                             <dl class="dl-horizontal">
                              ...
                              <dl class="dl-horizontal">
                                <dt>Start Date</dt>
                                <dd><?=date("jS M Y", strtotime($fet_cc_detl['crs_startdate']))?></dd>
                              </dl>
                              <dl class="dl-horizontal">
                                <dt>End Date</dt>
                                <dd><?=date("jS M Y", strtotime($fet_cc_detl['crs_enddate']))?></dd>
                              </dl>
						  ...
						  ?>
                            ...
                            <div class="pmbb-view">
                             ...
                             <dl class="dl-horizontal">
                              ...
                              <dl class="dl-horizontal">
                                <dt>Video Link</dt>
                                <dd><?=$fet_av_detl['link_video']?></dd>
                              </dl>
                              <dl class="dl-horizontal">
                                <dt>Comments</dt>
                                <dd><?=$fet_av_detl['comments']?></dd>
                              </dl>
				...
				?>
				 ...
				 ?>
                    ...
                    <div class="panel-heading" role="tab">
                      <h4 class="panel-title"> <!--<a data-toggle="collapse" data-parent="#accordionTeal" href="#accordionTeal-one" aria-expanded="true">--> <a>Insteuctional Video Presentation</a> <!--</a>--></h4>
						  ...
						  ?>
                            ...
                            <div class="pmbb-view">
                              <dl class="dl-horizontal">
                                ...
                                <dd><?=$fet_rvv_detl['dateofreference'];?></dd>
                              </dl>
                              <dl class="dl-horizontal">
                                <dt>Information</dt>
