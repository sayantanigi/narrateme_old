                    ...
                    <div id="mydiv">
                      ...
                      ?>
                        <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                          ...
                          <td><?php if($i->product_type_image==""){?>
                            No Image
                            <?php }else{?>
                          ...
                          <td style="max-width:50px;"><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>index.php/product_type/show_product_type_id/<?php echo $i->id; ?>">Edit</a></td>
                          <td style="max-width:50px;"><a class="btn red btn-sm btn-outline sbold uppercase" onclick="return confirm('Are you sure about this delete?');" href="<?php echo base_url()?>index.php/product_type/delete_product_type/<?php echo $i->id; ?>">Delete</a></td>
                        </tr>
