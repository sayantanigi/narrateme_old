              ...
              <table class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                ...
                ?>
                  ...
                  <tr class="odd gradeX">
                    ...
                    <td><?php echo date('d-m-Y',strtotime($i->from_date));?></td>

                    <td><?php echo date('d-m-Y',strtotime($i->to_date));?></td>
                    ...
                    <td><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>index.php/student/show_job_id/<?php echo $i->expid?>">Edit</a></td>

                    <td><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>index.php/student/delete_ajob/<?php echo $i->expid?>" onclick="return confirm('Are you sure you want to delete ?');">Delete</a></td>
