      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue-hoki">
            ...
            <form action="<?php echo base_url().'index.php/student/add_student_experience' ?>" class="form-horizontal form-bordered" method="post" >
                ...
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_input(array('id' => 'name', 'name' => 'employer_name','class'=>'form-control')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_input(array('id' => 'datepicker','name' => 'from_date','class'=>'form-control form-control-inline date-picker')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_input(array('id' => 'datepicker','name' => 'to_date','class'=>'form-control form-control-inline date-picker')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_input(array('id' => 'position','name' => 'position','class'=>'form-control')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_textarea(array('id' => 'cms_pagedes','name' => 'job_description','class'=>'form-control')); ?>
