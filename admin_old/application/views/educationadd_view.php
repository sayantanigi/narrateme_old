                ...
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_input(array('id' => 'city', 'name' => 'city','class'=>'form-control')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_input(array('id' => 'state', 'name' => 'state','class'=>'form-control')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_input(array('id' => 'zip_code', 'name' => 'zip_code','class'=>'form-control')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_input(array('id' => 'phone', 'name' => 'phone','class'=>'form-control','maxlength'=>'10')); ?>
