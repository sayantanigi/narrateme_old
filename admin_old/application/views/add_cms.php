      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue-hoki">
            ...
            <form action="<?php echo base_url().'index.php/cms/add_individual_cms' ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                ...
                <div class="form-actions">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-offset-3 col-md-9">
                     ...
                     <a href="<?php echo base_url()?>index.php/cms"> <button type="button" class="btn default">Cancel</button></a>
