       ...
       <?php echo form_input(array('id' => 'ind_id', 'name' => 'ind_id','type'=>'hidden','class'=>'form-control' ,'value'=>$this->uri->segment(3))); ?>
                <div class="form-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      <?php echo form_input(array('id' => 'activity_name', 'name' => 'activity_name','class'=>'form-control')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      <?php echo form_textarea(array('id' => 'cms_pagedes','name' => 'activity_description','class'=>'form-control')); ?>
                    </div>
                  </div>
                </div>
