                ...
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_input(array('id' => 'teacher_name', 'name' => 'teacher_name','class'=>'form-control')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_input(array('id' => 'course', 'name' => 'course','class'=>'form-control')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_input(array('id' => 'academic_program', 'name' => 'academic_program','class'=>'form-control')); ?>

                      <?php //echo form_error('academic_program'); ?>
                ...
                <div class="form-actions">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-offset-3 col-md-9">
                      ...
                      <a href="<?php echo base_url()?>index.php/teacher/view_teacher"><button type="button" class="btn default">Cancel</button></a>
