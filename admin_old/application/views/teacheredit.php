          ...
          <div class="portlet box blue-hoki">
            ...
            <div class="portlet-body form">
             ...
             <?php foreach($ecms as $i){?>
              ...
              <form method="post" class="form-horizontal form-bordered" action="<?php echo base_url()?>index.php/teacher/edit_teacher">
			  ...
			  <input type="hidden" name="id" id="id" value="<?php echo $i->id?>">
                ...
                <div class="form-body">
                  ...
                  <!--<div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <select class="form-control" name="member_type">
                        ...
                        <option value="1" <?php if($i->member_type == 1){?> selected <?php }?>>teacher</option>
                  ...
                  <div class="form-group">
                    ...
                    <label class="control-label col-md-3">learning_portal</label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <input type="text" class="form-control" id="course" value="<?php echo $i->course;?>" name="course">
                  ...
                  <div class="form-group">
                    ...
                    <label class="control-label col-md-3">academic_program</label>

                    <div class="col-md-5">

                      <input type="text" class="form-control" id="academic_program" value="<?php echo $i->academic_program;?>" name="academic_program">
                ...
                <div class="form-actions">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-offset-3 col-md-9">
                      ...
                      <a href="<?php echo base_url()?>index.php/teacher/view_teacher" <button class="btn default" type="button">Cancel</button></a>
