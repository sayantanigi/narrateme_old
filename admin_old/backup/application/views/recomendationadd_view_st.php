            ...
            <form action="<?php echo base_url().'index.php/student_record/add_recomendation' ?>" class="form-horizontal form-bordered" method="post" >
                ...
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <label class="control-label col-md-3">Recomendation Name</label>

                    <div class="col-md-5">

                      <?php echo form_input(array('id' => 'recomendation_person', 'name' => 'recomendation_person','class'=>'form-control')); ?>

                      <?php echo form_error('recomendation_person'); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                     ...
                     <?php echo form_input(array('id' => 'recomendation', 'name' => 'recomendation','class'=>'form-control')); ?>

                      <?php //echo form_error('recomendation'); ?>
