              ...
              <table class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th width="14%"> academic_program</th>
                ...
                ?>
                  ...
                  <tr class="odd gradeX">
                    ...
                    <td><?php echo $i->information;?></td>
					 ...
					 <td><?php echo $i->academic_program;?></td>
                    ...
                    <td><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>index.php/teacher/show_teacher_id/<?php echo $i->id?>">Edit</a></td>

                    <td><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>index.php/teacher/delete_teacher/<?php echo $i->id?>" onclick="return confirm('Are you sure you want to delete ?');">Delete</a></td>
