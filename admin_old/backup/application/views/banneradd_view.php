      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue-hoki">
            ...
            <!--<form action="<?php echo base_url().'index.php/banner/add_banner' ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data" >-->
				  ...
				  $steeurl = base_url().'index.php/banner/add_banner';
