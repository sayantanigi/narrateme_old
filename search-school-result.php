...
$query =mysql_query("select * from na_schools_facilities where school_name like '%$sch_name%' and ind_id!='".$_SESSION['userid']."'"); 
  ...
  <section id="content">
    <div class="container">
      <div class="block-header">
        <h2>Search Instructional Facilities or School Result</h2>
      </div>
      <div class="card">
							...
							?>
                                    ...
                                    <div class="pmbb-view jk" style="">
                                        ...
                                        <dl class="dl-horizontal">
                                            <dt>School Name</dt>
                                            <dd><?php echo $row_ins['school_name'];?></dd>
                                        </dl>
                                        <dl class="dl-horizontal">
                                            <dt>Bulletin</dt>
                                            <dd><?php echo $row_ins['school_bulletin'];?></dd>
                                        </dl>
                                        ...
                                        <dl class="dl-horizontal">
                                            <dt>Phone</dt>
                                            <dd><?php echo $row_ins['pnone_no'];?></dd>
                                        </dl>
                                        <dl class="dl-horizontal">
                                            <dt>Email</dt>
                                        ...
                                        <dl class="dl-horizontal">
                                            <dt>Description</dt>
                                            <dd style=""><?php echo $row_ins['school_information']?></dd>
                                        </dl>

                                        <dl class="dl-horizontal">
                                            <dt>Website</dt>
                                            <dd><?php echo $row_ins['schoolwebsite']?></dd>
                                        </dl>
										<div class="m-t-30">
