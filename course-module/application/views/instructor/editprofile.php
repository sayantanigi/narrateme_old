                      ...
                      <div class=" col-md-12 col-lg-12 ">
                        <table class="table table-user-information">
                          ...
                          <tbody>
                            <tr>
                              <td>First Name:</td>
                              <td><input type="text" name="first_name" value="<?php echo $mf->first_name?>" ></td>
                            </tr>
                            <tr>
                              <td>Last Name:</td>
                              <td><input type="text" name="last_name" value="<?php echo $mf->last_name?>" ></td>
                            </tr>
                            <tr>
                              <td>Address:</td>
                            ...
                            <tr>
                              ...
                              <td> <input type="text" class="form-control" id="" name="highest_qual" value="<?php echo $mf->highest_qual?>"></td>
                            </tr>
                            <tr>
                              <td>Experience:</td>
                              <td>
                                     <select class="form-control" name="exp">
                                <option <?php if($mf->exp=="1"){ echo 'selected'; }?>>1</option>
                            <option <?php if($mf->exp=="2"){ echo 'selected'; }?>>2</option>
                        </select>
                              </td>
                            </tr>
                           	<tr>
