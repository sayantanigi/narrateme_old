                    ...
                    <div class="row">
                      <div class="col-md-12 col-lg-12 " align="center">
                        <div class="ch_pic">
                          ...
                          <?php }?><span class="profile_name"><?php echo $mf->first_name?> &nbsp; <?php echo $mf->last_name?> </span></p>
                          <div class="box">
                      ...
                      <div class=" col-md-12 col-lg-12 ">
                        <table class="table table-user-information">
                          <tbody>
                            <tr>
                              <td>First Name:</td>
                              <td><?php echo $mf->first_name?></td>
                            </tr>
                            <tr>
                              <td>Lastst Name:</td>
                              <td><?php echo $mf->last_name?></td>
                            </tr>
                            <tr>
                              <td>Date of Birth</td>
                            ...
                            <tr>
                              <td>Gender</td>
                              <td><?php echo ucfirst($mf->gender)?></td>
                            </tr>
