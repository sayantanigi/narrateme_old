      ...
      <center>
       ...
       <div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  ...
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="<?php echo base_url()?>member/addtimetable">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					<label for="title" class="col-sm-2 control-label">Schedule Title</label>
					<div class="col-sm-10">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" name="start" required="" class="form-control" id="start">
					</div>
				  </div>
				  <div class="form-group">
					<label for="end" class="col-sm-2 control-label">End date</label>
					<div class="col-sm-10">
					  <input type="text" name="end"  required="" class="form-control" id="end">
					</div>
				  </div>
...
//				}
			...
			drop: function(date, allDay) { // this function is called when something is dropped
				...
				?>
				{
					title: '<?php echo $dtls->course_name;?> <?php  echo $dtls->schedule_title;?>',
					start: '<?php echo date('Y-m-d', strtotime($dtls->class_date));?>',
					endTime: '<?php echo date('Y-m-d', strtotime($dtls->class_date));?>',
