                    ...
                    <div id="mydiv">
                      ...
                      ?>
                        <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                          <td>
                          <input name="checkbox[]" class="checkbox1" type="checkbox"  value="<?php echo $i->book_id;?>">
                          </td>
                          ...
                          <td  style="max-width:250px;"><div class="form-group">
                              <div class="col-md-5">
                                <select name="blog_status" id="stachange" onchange="f1(this.value,<?php echo $i->id ;?>)" style="padding:4px;">
                                  <option value="paid" <?php if($i->pay_status=="paid"){?> selected="selected"<?php }?>>Paid</option>
                                  <option value="unpaid" <?php if($i->pay_status=="unpaid"){?> selected="selected"<?php }?>>Un Paid</option>
                                </select>
                                <input type="hidden" name="id" value="<?php echo $i->book_id;?>">
                              </div>
                            </div></td>
...
//                    return  false;
                    ...
                    $.ajax({
                        ...
                        $("#respose").html(data);
						//location.reload();
						var newurl= '<?php echo base_url() ?>supercontrol/paid/show_list';
