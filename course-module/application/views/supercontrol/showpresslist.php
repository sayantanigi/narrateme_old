                    ...
                    <div id="mydiv">
                      ...
                      ?>
                        <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                          ...
                          <!--<td><?php if($i->press_image==""){?>
                            No Image
                            <?php }else{?>
                            <img src="<?php echo base_url()?>/uploads/press/<?php echo $i->press_image;?>" width="150" height="100" style="border: 2px solid #ddd;"/>
                            <?php }?></td>-->
                          <td  style="max-width:200px;"><?php echo $i->press_title;?></td>
                          <td  style="max-width:200px;"><?php echo $i->posted_by;?></td>
                          <td  style="max-width:250px;"><div class="form-group">
                              <div class="col-md-5">
                                <select name="press_status" id="stachange" onchange="f1(this.value,<?php echo $i->id ;?>)" style="padding:4px;">
                                  <option value="1" <?php if($i->press_status==1){?> selected="selected"<?php }?>>Active</option>
                                  <option value="0" <?php if($i->press_status==0){?> selected="selected"<?php }?>>Inactive</option>
                                </select>
                                <input type="hidden" name="id" value="<?php echo $i->id;?>">
                              </div>
                            </div></td>
                            <td style="max-width:50px;"><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/press/view_press/<?php echo $i->id; ?>">View</a></td>
                          <td style="max-width:50px;"><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/press/show_press_id/<?php echo $i->id; ?>">Edit</a></td>
                          <td style="max-width:50px;"><a class="btn red btn-sm btn-outline sbold uppercase" onclick="return confirm('Are you sure about this delete?');" href="<?php echo base_url()?>supercontrol/press/delete_press/<?php echo $i->id; ?>">Delete</a></td>
                        </tr>
