              ...
              <div class="tab-pane active" id="tab_0">
                <div class="portlet box blue-hoki">
                  ...
                  <div class="portlet-body form">
                    ...
                    <form action="<?php echo base_url().'supercontrol/users/edit_idproof' ?>" class="form-horizontal form-bordered" id="fileForm" method="post" enctype="multipart/form-data">
                    <?php $id = $this->uri->segment(4);?>
                    <input type="hidden" name="userid" value="<?php echo $id; ?>">
                    <input type="hidden" name="attachment" value="<?php echo $at->id_proof; ?>">
                    <div class="form-body">
                    ...
                    <div class="col-md-3">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            ...
                            <a href="<?php echo base_url();?>uploads/idproof/<?php echo $at->id_proof; ?>" style="text-decoration:none;" download><?php echo $at->id_proof; ?></a>
                        </div>
