...
<div class="page-content-wrapper"> 
	<div class="page-content"> 
		...
		<div class="row">
			<a href="<?= base_url('supercontrol/batch/show_batch')?>" style="padding: 1%;" class="btn btn-primary pull-right">Back</a></h3>
			<div class="col-md-12">
						...
						<div class="tab-pane active" id="tab_0">
							<div class="portlet box blue-hoki">
								<div class="portlet-title">
									<div class="caption"> <i class="fa fa-gift"></i> Course Batch Location Details </div>
										...
										<div id="mydiv">
											<thead>
												<tr>
													...
													<th width="30">Batch Start Date</th>
													<th width="30">Batch End Date</th>
													<th width="30">Batch Start Time</th>
													<th width="30">Batch End Time</th>
													...
													foreach($eloca as $i){
														...
														<tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
															<td  style="max-width:200px;">
																...
																$wheredata = $i->batchId;
																$queryallcat = $this->generalmodel->getAllData("sm_batch","batchId",$wheredata,'','');
																echo $queryallcat[0]->batchName;
																?>
															</td>
															<td style="max-width:200px;"><?php echo $i->locationAddress;?></td>
															<td style="max-width:200px;"><?php echo $i->startDate;?></td>
															<td style="max-width:200px;"><?php echo $i->endDate;?></td>
														...
														<?php $ctn++; } ?>
													<?php } else { ?>
														<tr><td colspan="8"><p class="error"> No Batch Location Found</p></td></tr>
													<?php } ?>
												</tbody>
											</div>
										</table>
