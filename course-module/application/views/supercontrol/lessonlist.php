                    ...
                    <div id="mydiv">
                      ...
                      ?>
                        <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                          <td>
                          <input name="checkbox[]" class="checkbox1" type="checkbox"  value="<?php echo $i->lession_id;?>">
                          </td>
                           <td  style="max-width:200px;"><?php echo $i->lession_id;?></td>
                          <td  style="max-width:200px;"><?php echo $i->start_date;?></td>
                          <td  style="max-width:200px;"><?php echo $i->start_time;?></td>
                           <td  style="max-width:200px;"><?php echo $i->end_time;?></td>
                          <td style="max-width:50px;"><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/course/edit_lesson/<?php echo $i->lession_id; ?>">Edit</a></td>
                          <td style="max-width:50px;"><a class="btn red btn-sm btn-outline sbold uppercase" onclick="return confirm('Are you sure about this delete?');" href="<?php echo base_url()?>supercontrol/course/delete_lesson/<?php echo $i->lession_id; ?>">Delete</a></td>
                        </tr>
