    ...
    <div class="page-content">
      ...
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li> <span>Show Mode List </span> </li>
        </ul>
      </div>
      <!-- END PAGE BAR -->
      <!-- BEGIN PAGE TITLE-->
              ...
              <div class="tab-pane active" id="tab_0">
                <div class="portlet box blue-hoki">
                  <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-gift"></i>Show Mode</div>
                    ...
                    <div id="mydiv">
                      ...
                      ?>
                        <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                          ...
                          <td  style="max-width:200px;"><?php echo $i->mode_title;?></td>
                          <td  style="max-width:250px;"><div class="form-group">
                              <div class="col-md-5">
                                <select name="mode_status" id="stachange" onchange="f1(this.value,<?php echo $i->id ;?>)" style="padding:4px;">
                                  <option value="1" <?php if($i->mode_status==1){?> selected="selected"<?php }?>>Active</option>
                                  <option value="0" <?php if($i->mode_status==0){?> selected="selected"<?php }?>>Inactive</option>
                                </select>
                          ...
                          <td style="max-width:50px;"><a class="btn blue btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/mode/show_mode_id/<?php echo $i->id; ?>">Edit</a></td>
