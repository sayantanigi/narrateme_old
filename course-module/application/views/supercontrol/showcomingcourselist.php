                      ...
                      <div id="mydiv">
                        ...
                        <tbody>
                          ...
                          <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                            ...
                            <td  style="max-width:250px;">
                            <a class="btn green btn-sm btn-outline uppercase" href="<?php echo base_url();?>supercontrol/course/add_course_clone_coming_soon/<?php echo $i->course_id; ?>"><i class="fa fa-plus" aria-hidden="true"></i> Course Clone</a> 
                            </td>
