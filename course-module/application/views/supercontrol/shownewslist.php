                    ...
                    <div id="mydiv">
                      <thead>
                        <tr>
                          ...
                          <!--<th width="100" style="max-width:170px;">Image</th>-->
                          <th width="30">News Title</th>
                          <th width="30">Posted By</th>
                          <th width="30">News Link</th>
                      ...
                      ?>
                        <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                          ...
                          <!--<td><?php if($i->news_image==""){?>
                            No Image
                            <?php }else{?>
                            <img src="<?php echo base_url()?>news/<?php echo $i->news_image;?>" width="150" height="100" style="border: 2px solid #ddd;"/>
                            <?php }?></td>-->
                          <td  style="max-width:150px;"><?php echo $i->news_title;?></td>
                          <td  style="max-width:200px;"><?php echo $i->posted_by;?></td>
                          <td  style="max-width:150px;"><a href="<?php echo $i->news_link;?>" target="_blank"><?php echo $i->news_link;?></a></td>
                          <td  style="max-width:250px;"><div class="form-group">
                              <div class="col-md-5">
                                <select name="blog_status" id="stachange" onchange="f1(this.value,<?php echo $i->id ;?>)" style="padding:4px;">
                                  <option value="1" <?php if($i->news_status==1){?> selected="selected"<?php }?>>Active</option>
                                  <option value="0" <?php if($i->news_status==0){?> selected="selected"<?php }?>>Inactive</option>
                                </select>
                                <input type="hidden" name="id" value="<?php echo $i->id;?>">
                              </div>
                            </div></td>
                          <td style="max-width:80px;"><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/news/show_news_id/<?php echo $i->id; ?>">Edit</a></td>
                          <td style="max-width:80px;"><a class="btn red btn-sm btn-outline sbold uppercase" onclick="return confirm('Are you sure about this delete?');" href="<?php echo base_url()?>supercontrol/news/delete_news/<?php echo $i->id; ?>">Delete</a></td>
                        </tr>
