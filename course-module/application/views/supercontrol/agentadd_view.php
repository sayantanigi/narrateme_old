              ...
              <div class="tab-pane active" id="tab_0">
                <div class="portlet box blue-hoki">
                  <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-gift"></i>Add Agent</div>
                    <div class="tools"> <a href="javascript:;" class="collapse"> </a> <a href="#portlet-config" data-toggle="modal" class="config"> </a> <a href="javascript:;" class="reload"> </a> <a href="javascript:;" class="remove"> </a> </div>
                  </div>
                  <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form action="<?php echo base_url().'supercontrol/agent/add_agent' ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                    ...
                    <div class="col-md-8"> <?php echo form_input(array('id' => 'agent_title', 'name' => 'agent_title','class'=>'form-control')); ?>
                    <?php echo form_error('agent_title'); ?>
                    </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="col-md-8"> <?php echo form_textarea(array('id' => 'pagedes', 'name' => 'agent_desc','class'=>'form-control')); ?>
                    <?php echo form_error('agent_desc'); ?>
                    </div>
                    </div>
                    </div>
