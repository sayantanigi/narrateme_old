              ...
              <div class="tab-pane active" id="tab_0">
                <div class="portlet box blue-hoki">
                  ...
                  <div class="portlet-body form"> 
                    <!-- BEGIN FORM-->
                    <form action="<?php echo base_url().'supercontrol/course/add_course_trainingmaterial'?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                      <div class="form-body">
                           <div class="form-group">
                          <label class="control-label col-md-3">Training Material PDF</label>
                          <div class="col-md-9">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                              ...
                              <div> <span class="btn default btn-file"> <span class="fileinput-new"> Select PDF </span> <span class="fileinput-exists"> Change </span>
                                <?php
                                $file = array('type' => 'file','name' => 'training_material_files', 'onchange' => 'readURL(this);' );
                                echo form_input($file);
                                ?>
                                </span> <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput"> Remove </a> </div>
                            </div>
                            <div class="clearfix margin-top-10"> <span class="label label-danger">Format</span> pdf,doc,docx,ppt,txt </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-md-3">Training Material Title</label>
                          <div class="col-md-8">
							<?php echo form_input(array('id' => '', 'name' => 'training_material_name','class'=>'form-control')); ?>
                            <?php echo form_error('training_material_name'); ?>
                          </div>
                        </div>
                      <!--  <div class="form-group">
                          <label class="control-label col-md-3">Training Material Content</label>
                          <div class="col-md-8"> 
