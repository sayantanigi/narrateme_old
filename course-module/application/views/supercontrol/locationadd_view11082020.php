                  ...
                  <div class="portlet-body form"> 
                    ...
                    <form action="<?php echo base_url().'supercontrol/location/add_location' ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                      <div class="form-body">
                        ...
                        <input type="hidden" name="course_id" value="<?=$idd;?>">
                        ...
                        <!--<div class="form-group">
                          ...
                          <div class="col-md-5">
                            <input type="text" class="form-control" id="datetimepicker2" value="" name="start_date">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-md-3">Location end date</label>
                          <div class="col-md-5">
                            <input type="text" class="form-control" id="datetimepicker2e" value="" name="end_date">
                          </div>
                        </div>-->
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-5">
                            <input type="text" required="" class="form-control" id="hour_no" value="" name="hour_no" onkeypress="return isNumber(event)">
                          </div>
                        </div>
                      </div>
