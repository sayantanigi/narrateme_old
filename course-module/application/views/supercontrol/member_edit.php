              ...
              <div class="tab-pane active" id="tab_0">
                <div class="portlet box blue-hoki">
                  <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-gift"></i>Edit Details</div>
                  ...
                  <div class="portlet-body form"> 
                   <?php if($this->session->flashdata('edit_message')!=''){?>
                    ...
                    <div class="form-group"> <b>
                          ...
                          <div class="col-md-8">
                            <input type="text" name="first_name" id="title" value="<?=$c->first_name;?>" class="form-control" placeholder="Course Name" onkeyup= "leftTrim(this)"/>
                        ...
                        <div class="form-group"> <b>
                          ...
                          <div class="col-md-8">
                            <input type="text" name="last_name" id="title" value="<?=$c->last_name;?>" class="form-control" placeholder="Course Name" onkeyup= "leftTrim(this)"/>
                            <label id="errorBox"></label>
                          </div>
                        </div>
                        ...
                        <div class="form-group"> <b>
                          ...
                          <div class="col-md-8">
                            <input type="email" name="email" id="title" value="<?=$c->email;?>" class="form-control" placeholder="Course Name" onkeyup= "leftTrim(this)"/>
                            <label id="errorBox"></label>
                          </div>
                        </div>
                        ...
                        <div class="form-group"> <b>
                          ...
                          <div class="col-md-8">
                            <input type="text" name="phoneno" id="title" value="<?=$c->phoneno;?>" class="form-control" placeholder="Course Name" onkeyup= "leftTrim(this)"/>
                            <label id="errorBox"></label>
                          </div>
                        </div>
                      <div class="form-body">
