              ...
              <div class="tab-pane active" id="tab_0">
                <div class="portlet box blue-hoki">
                  <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-gift"></i>Show Faq</div>
                    ...
                    <div id="mydiv">
                      ...
                      ?>
                        <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                          ...
                          <td  style="max-width:200px;"><?php echo $i->question;?></td>
                          <td  style="max-width:200px;"><?php echo substr(stripslashes($i->answer),0,50);?>.....</td>
                          <td  style="max-width:250px;"><div class="form-group">
                              <div class="col-md-5">
                                <select name="blog_status" id="stachange" onchange="f1(this.value,<?php echo $i->id ;?>)" style="padding:4px;">
                                  <option value="1" <?php if($i->faq_status==1){?> selected="selected"<?php }?>>Active</option>
                                  <option value="0" <?php if($i->faq_status==0){?> selected="selected"<?php }?>>Inactive</option>
                                </select>
                                <input type="hidden" name="id" value="<?php echo $i->id;?>">
                              </div>
                            </div></td>
                            <td><a class="btn sbold yellow" href="<?php echo base_url()?>supercontrol/faq/faq_view/<?php echo $i->id?>"><i class="fa fa-eye"></i> View </a></td>
                          <td style="max-width:50px;"><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/faq/show_faq_id/<?php echo $i->id; ?>">Edit</a></td>
                          <td style="max-width:50px;"><a class="btn red btn-sm btn-outline sbold uppercase" onclick="return confirm('Are you sure about this delete?');" href="<?php echo base_url()?>supercontrol/faq/delete_faq/<?php echo $i->id; ?>">Delete</a></td>
                        </tr>
...
//                    return  false;
					 //alert ("<?php echo base_url() ?>supercontrol/controllers/faq/delete_multiple");
                    $.ajax({
						  
                        url: '<?php echo base_url() ?>supercontrol/faq/delete_multiple',
                        type: 'post',
                        data: 'ids=' + checkValues
                    }).done(function(data) {
                        $("#respose").html(data);
						//location.reload();
						var newurl= '<?php echo base_url() ?>supercontrol/faq/show_faq';
...
<script>
		...
		$.ajax({
		type:"get",
		url:"<?php echo base_url(); ?>supercontrol/faq/statusfaq",
