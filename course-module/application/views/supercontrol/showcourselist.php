              ...
              <div class="tab-pane active" id="tab_0">
                <div class="portlet box blue-hoki">
                  <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-gift"></i> Course Booking Details </div>                    <button class="btn btn-warning btn-sm pull-right" id="del_all" style="padding:5px; margin:8px;" onclick="return confirm('Are you sure about this delete?');">Delete selected</button>
                        ...
                        <tbody>
                          ...
                          <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                            ...
                            <td  >
                              ...
                              <b>Who should Attend  </b>:        <?php echo $i->who_should_apply;?></br>
                            ...
                            <td  style="max-width:250px;">
                            <a class="btn green btn-sm btn-outline uppercase" href="<?php echo base_url();?>supercontrol/course/add_course_trainingmaterial_view/<?php echo $i->course_id; ?>"><i class="fa fa-plus" aria-hidden="true"></i> Training Material</a> 
                            <a class="btn green btn-sm btn-outline uppercase" href="<?php echo base_url();?>supercontrol/course/trainingmaterial_list/<?php echo $i->course_id; ?>"><i class="fa fa-eye" aria-hidden="true"></i> Training Material</a>
                            </td>

                             <td  style="max-width:250px;">
                             <a class="btn green btn-sm btn-outline uppercase" href="<?php echo base_url();?>supercontrol/course/add_course_session_view/<?php echo $i->course_id; ?>"><i class="fa fa-plus" aria-hidden="true"></i> Course Session</a>
                             <a class="btn green btn-sm btn-outline uppercase" href="<?php echo base_url();?>supercontrol/course/course_session_list/<?php echo $i->course_id; ?>"><i class="fa fa-eye" aria-hidden="true"></i> Course Session List</a>

                            </td>
                            <td  style="max-width:250px;">
                            <a class="btn green btn-sm btn-outline uppercase" href="<?php echo base_url();?>supercontrol/course/add_course_clone/<?php echo $i->course_id; ?>"><i class="fa fa-plus" aria-hidden="true"></i> Course Clone</a> 
                            </td>
