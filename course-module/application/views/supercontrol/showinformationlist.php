    ...
    <div class="page-content">
      ...
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li> <span>Show Information List </span> </li>
        </ul>
      </div>
      <!-- END PAGE BAR -->
      <!-- BEGIN PAGE TITLE-->
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_2">
                      ...
                      <tbody>
                        ...
                        <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_2">
                          ...
                          <td  style="max-width:200px;"><?php echo $i->information_name;?></td>
                              ...
                              <div class="modal fade" id="myModal<?php echo $ctn; ?>" role="dialog">
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    <form action="<?php echo base_url()?>supercontrol/information/send_information" method="post">
                                      ...
                                      <div class="modal-body" style="text-align:center;">
                                        <input type="hidden" name="information_id" value="<?php echo $i->information_id;?>">
                                        ...
                                        <br />
                                        <label>
                                          <textarea type="text" id="pagedes3" name="reply_message" value="" style="height:100px;width:448px; border:1px solid #999; margin-left:49px;" placeholder="Messsage"  > </textarea>
                                        </label>
                                      </div>
                          ...
                          <td style="max-width:50px;"><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/information/show_information_id/<?php echo $i->information_id; ?>">View</a></td>
                          <td><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/information/delete_row/<?php echo $i->information_id;?>" onclick="return confirm('Are you sure you want to delete ?');">Delete</a></td>
                        </tr>
                        <?php $ctn++;}
						}
						?>
