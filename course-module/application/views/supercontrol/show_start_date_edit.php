              ...
              <div class="tab-pane active" id="tab_0">
                <div class="portlet box blue-hoki">
                  <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-gift"></i>Add Start Date</div>
                  ...
                  <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                     <?php if(is_array($ecms)): ?>
                      ...
                      foreach($ecms as $i){
                      ?>
                    <form action="<?php echo base_url().'supercontrol/location/edit_start_date' ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                    <?php $idd = $this->uri->segment(4); ?>
                    <input type="hidden" name="st_id" value="<?=$idd;?>">
                    <div class="form-group">
                    <label class="control-label col-md-3">Location start date</label>
                    <div class="col-md-5">
                    <input type="text" class="form-control" id="datetimepicker2" value="<?php echo date('d-m-Y', strtotime($i->start_date));?>" name="start_date" required="required">
                    </div>
                    </div>
