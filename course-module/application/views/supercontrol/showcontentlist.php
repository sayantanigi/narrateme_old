            ...
            <div class="page-content-wrapper">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                             ...
                             <li>
                                <span>Show All Page Content </span>
                            </li>
                        </ul>
                                    ...
                                    <div class="tab-pane active" id="tab_0">
                                        <div class="portlet box blue-hoki">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>Show All Page Content</div>
                                                <div class="tools">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="hidden-480">Page Description</th>
                ...
                ?>
                    <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                        ...
                        <td  class="hidden-480"><?php echo $i->page_title;?></td>
                        <td  class="hidden-480"><?php echo $i->content_title;?></td>
                        <td class="hidden-480"><?php echo substr(stripslashes(strip_tags($i->content_details)),0,80);?>.....</td>
                        <td class="hidden-480"><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/Content/show_cms_id/<?php echo $i->id; ?>">Edit</a></td>
                  </tr>
                  <?php $c++; }?>
                </tbody>
              </table>
