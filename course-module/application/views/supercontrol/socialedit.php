      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="portlet box blue-hoki">
            ...
            <form action="<?php echo base_url().'index.php/social/edit_social' ?>" class="form-horizontal form-bordered" method="post" >
            <input type="hidden" name="id" value="<?php echo $i->id;?>">
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <?php echo form_input(array('id' => 'name', 'name' => 'name','class'=>'form-control'),$i->name); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <?php echo form_input(array('id' => 'ip_address', 'name' => 'ip_address','class'=>'form-control') ,$i->ip_address); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      <?php echo form_input(array('id' => 'website', 'name' => 'website','class'=>'form-control') ,$i->website); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <?php echo form_input(array('id' => 'domain_name', 'name' => 'domain_name','class'=>'form-control') ,$i->domain_name); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <?php echo form_input(array('id' => 'url', 'name' => 'url','class'=>'form-control','maxlength'=>'10') ,$i->url); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <?php echo form_input(array('id' => 'marking_media', 'name' => 'marking_media','class'=>'form-control') ,$i->marking_media); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <?php echo form_input(array('id' => 'add_meterial', 'name' => 'add_meterial','class'=>'form-control') ,$i->add_meterial); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <?php echo form_input(array('id' => 'marketing_meterial', 'name' => 'marketing_meterial','class'=>'form-control') ,$i->marketing_meterial); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <?php echo form_input(array('id' => 'commercials', 'name' => 'commercials','class'=>'form-control') ,$i->commercials); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <?php echo form_input(array('id' => 'infomercials', 'name' => 'infomercials','class'=>'form-control') ,$i->infomercials); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <?php echo form_input(array('id' => 'media_link', 'name' => 'media_link','class'=>'form-control') ,$i->media_link); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <?php echo form_input(array('id' => 'network_site', 'name' => 'network_site','class'=>'form-control') ,$i->network_site); ?>
