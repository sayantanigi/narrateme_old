      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="portlet box blue-hoki">
            ...
            <div class="btn-group">
            <a class="btn green" href="<?php echo base_url()?>index.php/time" data-toggle="modal">
            Add New
            <i class="fa fa-plus"></i>
              ...
              <table class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                ...
                ?>
                  <tr class="odd gradeX">
                    <!--<td><?php $pic = base_url().'time/'.$i->time_image; ?>
                    ...
                    <td><?php echo $i->entry_time;?></td>
					<td><?php echo $i->exit_time;?></td>
                    ...
                    <td><?php if($i->status ==1){?>
                      ...
                      <?php }?></td>
                    <td><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>index.php/time/show_time_id/<?php echo $i->id?>"><i class="fa fa-edit"></i> Edit</a></td>
                    <td><a class="btn red btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>index.php/time/delete_time/<?php echo $i->id?>" onclick="return confirm('Are you sure you want to delete ?');"><i class="fa fa-trash"></i> Delete</a></td>
                  </tr>
                  <?php }?>
                </tbody>
              </table>
