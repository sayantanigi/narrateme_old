                                    ...
                                    <div class="tab-pane active" id="tab_0">
                                        <div class="portlet box blue-hoki">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>View Course Query</div>
                                                <div class="tools">
                                            ...
                                            <div class="portlet-body form">
                                               ...
                                               <table class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1"><br />
                                                <tr><td >Contact Name :</td>  <td><?php echo $i->ContactName;?></td></tr>
                                                <tr><td >Email Address :</td>  <td><?php echo $i->Email;?></td></tr> 
                                                <tr><td >Phone Number :</td>  <td><?php echo $i->Phone;?></td></tr> 
                                                <tr><td >Subject:</td>  <td><?php echo $i->Subject;?></td></tr>        
...
<td style="max-width:70px;"><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/contact/show_contact" style="width:70px;">Back</a></td></div>
                                                <!-- END FORM-->
                                            </div>
                                        </div>
                                    </div>
