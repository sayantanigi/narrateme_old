    ...
    <div class="page-content">
      ...
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li> <span>Show Course Query List </span> </li>
        </ul>
      </div>
      <!-- END PAGE BAR -->
      <!-- BEGIN PAGE TITLE-->
              ...
              <div class="tab-pane active" id="tab_0">
                <div class="portlet box blue-hoki">
                  <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-gift"></i>View Course Query</div>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_2">
                      <thead>
                        <tr>
                          ...
                          <th width="10" style="max-width:170px;">Name</th>
                      ...
                      <tbody>
                        ...
                        <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_2">
                          ...
                          <td  style="max-width:200px;"><?php echo $i->ContactName;?></td>
                              ...
                              <div class="modal fade" id="myModal<?php echo $ctn; ?>" role="dialog">
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    <form action="<?php echo base_url()?>supercontrol/coursequery/send_coursequery" method="post">
                                      ...
                                      <div class="modal-body" style="text-align:center;">
                                        <input type="hidden" name="ContactId" value="<?php echo $i->ContactId;?>">
                                        ...
                                        <br />
                                        <label>
                                          <textarea type="text"  name="reply_message" value="" style="height:100px;width:448px; border:1px solid #999; margin-left:49px;" placeholder="Messsage"  > </textarea>
                                        </label>
                                      </div>
                          ...
                          <td style="max-width:50px;"><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/coursequery/show_coursequery_id/<?php echo $i->ContactId; ?>">View</a></td>
                          <td><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/coursequery/delete_row/<?php echo $i->ContactId;?>" onclick="return confirm('Are you sure you want to delete ?');">Delete</a></td>
                        </tr>
                        <?php $ctn++;}
						}
						?>
