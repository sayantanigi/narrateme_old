    ...
    <div class="page-content">
      ...
      <div class="alert alert-success alert-dismissable" style="padding:10px;">
        ...
        <?php 
				...
				if($last=="success"){echo "Country Added Successfully ......";}
				if($last=="successdelete"){echo "Country Deleted Successfully ......";}
            ?>
        </strong> </div>
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="tab-pane active" id="tab_0">
                <div class="portlet box blue-hoki">
                  <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-gift"></i>Add Country</div>
                    <div class="tools"> <a href="javascript:;" class="collapse"> </a> <a href="#portlet-config" data-toggle="modal" class="config"> </a> <a href="javascript:;" class="reload"> </a> <a href="javascript:;" class="remove"> </a> </div>
                  </div>
                  <div class="portlet-body form"> 
                    <!-- BEGIN FORM-->
                    <form action="<?php echo base_url().'supercontrol/country/add_country'?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data" onsubmit="return check();">
                      <div class="form-body">
                        ...
                        <div class="form-group"> 
                          ...
                          <div class="col-md-4">
                            <input type="text" name="country_name" id="title" class="form-control" placeholder="Name" onkeyup= "leftTrim(this)"/>
                        ...
                        <!--<div class="form-group"> <b>
                          ...
                          <div class="col-md-4">
                            <input type="text" name="sorting_order" id="title" class="form-control" placeholder="Sort Order" onkeyup= "leftTrim(this)"/>
                            <label id="errorBox"></label>
                          </div>
                        </div>-->
