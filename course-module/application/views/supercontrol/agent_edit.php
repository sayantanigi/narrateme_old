                ...
                <div class="portlet box blue-hoki">
                  ...
                  <div class="portlet-body form">
                    ...
                    <form method="post" class="form-horizontal form-bordered" action="<?php echo base_url().'supercontrol/agent/edit_agent '?>" enctype="multipart/form-data">
                      <div class="form-body">
                        <input type="hidden" name="agent_id" value="<?=$i->id;?>">
                        <input type="hidden" name="agent_image" value="<?=$i->agent_image;?>">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-5">
                            <input type="text" class="form-control" id="agent_title" value="<?php echo $i->agent_title;?>" name="agent_title">
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-7">
                            <textarea class="form-control" name="agent_desc" rows="6" id="pagedes"><?php echo $i->agent_desc;?></textarea>
                          </div>
                        </div>
                      </div>
