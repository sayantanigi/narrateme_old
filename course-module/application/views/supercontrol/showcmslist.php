            ...
            <div class="page-content-wrapper">
                                    ...
                                    <div class="tab-pane active" id="tab_0">
                                        <div class="portlet box blue-hoki">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>Show CMS</div>
                                                <div class="tools">
                ...
                ?>
                    <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                        ...
                        <td  class="hidden-480"><?php echo $i->cms_pagetitle;?></td>
                        <td  class="hidden-480"><?php echo $i->cms_heading;?></td>
                        <td class="hidden-480"><?php echo substr(stripslashes(strip_tags($i->description)),0,80);?>.....</td>
                        <td class="hidden-480"><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/cms/show_cms_id/<?php echo $i->id; ?>">Edit</a></td>
                  </tr>
                  <?php $c++; }?>
                </tbody>
              </table>
