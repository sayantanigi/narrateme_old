                    ...
                    <div id="mydiv">
                      <thead>
                        <tr>
                          ...
                          <!--<th width="30">Training Material Order</th>
                      ...
                      ?>
                        <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                          ...
                          <td><?php echo $ctn;?></td>
                           <td>
                                    <?php if(!empty($i->training_material_files)): ?>
                                             <a href="<?php echo site_url('uploads/trainingmaterial/'.$i->training_material_files);?>"><i class="fa fa-file-pdf-o fa-lg" aria-hidden="true"></i></a>
                           ...
                           <td  style="max-width:200px;"><?php echo $i->training_material_name;?></td>
                          ...
                          <td style="max-width:50px;"><a class="btn green btn-sm btn-outline sbold uppercase" href="<?php echo base_url()?>supercontrol/course/edit_trainingmaterial_view/<?php echo $i->training_material_id;?>">Edit</a></td>
                          <td style="max-width:50px;"><a class="btn red btn-sm btn-outline sbold uppercase" onclick="return confirm('Are you you want to  delete?');" href="<?php echo base_url()?>supercontrol/course/delete_trainingmaterial/<?php echo $i->training_material_id; ?>">Delete</a></td>
                        </tr>
