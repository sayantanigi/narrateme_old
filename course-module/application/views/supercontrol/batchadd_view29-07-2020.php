                     ...
                     <div class="tab-pane active" id="tab_0">
                        <div class="portlet box blue-hoki">
                           <div class="portlet-title">
                              <div class="caption"> <i class="fa fa-gift"></i>Add Batch</div>
                              ...
                              <form action="<?php echo base_url().'supercontrol/batch/add'?>" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="check()">
                                 <div class="form-body">
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-8">
                                          <select name="course_category" class="form-control">
                                             ...
                                             <option value="<?php echo $ac->course_id?>"><?php echo $ac->course_name?></option>
                                             <?php }?>
                                          </select>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-8">
                                          <input type="text" name="batch_name" required=""  class="form-control" placeholder="Batch Name" onkeyup= "leftTrim(this)"/>
                                          <label id="errorBox"></label>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-8">
                                          <input type="text" name="batch_location" required=""  class="form-control" placeholder="" onkeyup= "leftTrim(this)"/>
                                          <label id="errorBox"></label>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-8">
                                          <input type="text" class="form-control value="" name="price" required="required">
                                          <label id="errorBox"></label>
                                       </div>
                                    </div>
                                    <div class="form-group">
