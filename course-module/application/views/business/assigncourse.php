...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12" id="content">
      <center>
        <h1 class="page-header1" id="at" >Assign Course to <font color="#005CA9">Member</font></h1>
      </center>
    </div>
    <div class="col-lg-12">
      <div class="row">
                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class=" col-md-12 col-lg-12 ">
                      <form method="post" name="myForm" action="<?php echo base_url()?>member/memberpayment" onsubmit="return validateForm()">
            ...
            <?php } ?>
                        <div class="">
                          <div class="form-group">
                            ...
                            <select id="dates-field2" class="multiselect-ui form-control" name="memberid[]" multiple="multiple">
                              <?php foreach($currentstudents as $cs){ ?>
                              <option value="<?php echo $cs->email;?>"><?php echo $cs->first_name." ".$cs->last_name." ".$cs->email?></option>
                              <?php } ?>
                            </select>
                          </div>
                        </div>
                       ...
                       <div class="form-group">
                         ...
                         <select name="courseid" class="form-control" onBlur="getPrice(this.value, <?=$value->price;?>);">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Course Modes</label>
                      ...
                      <p id="status"></p>
                        ...
                        <div class="form-group">
                          <div class="col-sm-4 col-sm-push-4 text-center">
                            ...
                            <button  type="submit" class="btn btn-default cstm_btn payment_buttons">Payment</button>
...
<script type="text/javascript">
  function validateForm() {
    var x = document.forms["myForm"]["memberid"].value;
    if (x == "") {
        alert("Please Select Member");
        return false;
    }
    var y=document.forms["myForm"]["courseid"].value;
    if(y=="")
    {
  ...
  //var count = $("#dates-field2 :selected").length;
  //alert(count);
  function getPrice(val,price) {
   //alert(val);
   //alert(price);
   $("#status").html(price);
  /*$.ajax({
  type: "POST",
  url: "<?php echo base_url();?>member/getpricecourse",
  data:'country_id='+val,
