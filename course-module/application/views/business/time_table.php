...
<!--         <script src='<?php echo base_url()?>user_panel/js/jquery-1.10.2.js'></script>-->
  ...
  <?php if($this->session->flashdata('msg')!=''){?>
     <div class=" col-md-12 col-lg-12"><?php echo $this->session->flashdata('msg'); ?>
    </div>
     <?php }?>
     <?php  // print_r($details);  ?>
<div id='calendar'></div>
...
//				}
			...
			if($details !=''){
				foreach($details as $dtls){ ?>
					{
						title: '[<?php echo $dtls->course_name;?> <?php echo($dtls->student_id); ?>]',
						start: '<?php echo date('Y-m-d', strtotime($dtls->book_date));?>',
						endTime: '<?php echo date('Y-m-d', strtotime($dtls->start_date));?>',
