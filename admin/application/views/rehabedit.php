          ...
          <div class="portlet box blue-hoki">
            ...
            <div class="portlet-body form">
             ...
             <?php foreach($ecms as $i){?>
              ...
              <form method="post" class="form-horizontal form-bordered" action="<?php echo base_url()?>index.php/student/edit_rehabilitation">
                ...
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <input type="text" class="form-control form-control-inline date-picker" id="rehab_date" value="<?php echo $i->rehab_date;?>" name="rehab_date">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <input type="text" class="form-control" id="cms_pagedes" value="<?php echo strip_tags($i->description);?>" name="description">
