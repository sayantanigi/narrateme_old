                ...
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      <?php echo form_input(array('id' => 'rehab_name', 'name' => 'rehab_name','class'=>'form-control')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      <?php echo form_input(array('id' => 'rehab_date', 'name' => 'rehab_date','class'=>'form-control form-control-inline date-picker')); ?>

                      <?php echo form_error('rehab_date'); ?>
