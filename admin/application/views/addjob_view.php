      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue-hoki">
            ...
            <form action="<?php echo base_url().'individual/addjob' ?>" class="form-horizontal form-bordered" method="post" >
                ...
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php echo form_input(array('id' => 'employer_name', 'name' => 'employer_name','class'=>'form-control')); ?>
