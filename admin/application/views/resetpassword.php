        ...
        <div class="col-md-4">
          ...
          <div class="portlet box blue-hoki">
            ...
            <?php echo form_open('main/reset_password'); ?>
                ...
                <h3 class="form-title font-green" style="font-weight:300 !important;"><i class="fa fa-user"></i> Reset Password</h3>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control small_control_field form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Old Password" name="old_password" /> </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control small_control_field form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="New Password" name="newpassword" /> </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control small_control_field form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Confirm Password" name="re_password" /> </div>
