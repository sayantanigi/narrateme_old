          ...
          <div class="portlet box blue-hoki">
            ...
            <div class="portlet-body form">
             ...
             <?php foreach($ecms as $i){?>
              ...
              <form method="post" class="form-horizontal form-bordered" action="<?php echo base_url()?>index.php/recomendation/edit_recomendation">
                ...
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <input type="text" class="form-control" id="name" value="<?php echo $i->recomendation_person;?>" name="recomendation_person">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      ...
                      <input type="text" class="form-control" id="recomendation" value="<?php echo strip_tags($i->recomendation);?>" name="recomendation">
                  ...
                  <div class="form-group">
                    ...
                    <label class="control-label col-md-3">Recorder Video Link</label>

                    <div class="col-md-5">

                      <input type="text" class="form-control" id="rec_video_link" value="<?php echo $i->rec_video_link;?>" name="rec_video_link">
